                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                          ...
                                          <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> Edit service</h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Service Name in Arabic</label>
                                                            <input type="text" class="form-control @error('name_ar') is-invalid
                                                            @enderror" name="name_ar" placeholder="" value="{{$service->name_ar}}">
                                                            @error('name_ar')
                                                    ...
                                                    <div class="form-group">
                                                     <label>service Name in English</label>
                                                       <input type="text" class="form-control @error('name_en') is-invalid
                                                            ...
                                                            @enderror" name="name_en" placeholder="" value="{{$service->name_en}}">
                                                          @error('name_en')
                                                           <div class="alert alert-danger">   {{$message}}</div>
                                                         @enderror
                                                          </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @enderror" name="description_ar" value="{{$service->description_ar}}">
                                                       ...
                                                       @enderror
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            @enderror" name="description_en" value="{{$service->description_en}}" >
