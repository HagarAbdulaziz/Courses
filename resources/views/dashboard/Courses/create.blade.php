                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    @enderror" name="instructor_name_ar" placeholder="">
                                                            ...
                                                            <div class="form-group">
                                                             <label>instructor_name in English</label>
                                                               <input type="text" class="form-control @error('instructor_name_en') is-invalid
                                                                    ...
                                                                    @enderror" name="instructor_name_en" placeholder="">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    @enderror" name="duration_ar" placeholder="">
                                                                    @error('duration_ar')
                                                                        <div class="alert alert-danger">   {{$message}}</div>
                                                                    @enderror
                                                                  </div>
                                                          ...
                                                          <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                @enderror" name="duration_en" placeholder="">
                                                                @error('duration_en')
                                                                    <div class="alert alert-danger">   {{$message}}</div>
                                                                @enderror
                                                              </div>
